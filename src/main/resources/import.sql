INSERT INTO "user" (username, name, password, role) values ('rtalavera', 'rafael talavera', '$2a$10$rRT8tDUB484BwMpB2QcF2Of3iVjameqblXHbJUodFaQqgO1MqCdEq', 'CUSTOMER');
INSERT INTO "user" (username, name, password, role) values ('amartino', 'alejandra martino', '$2a$10$V0/Ze7P/Ezr4wOs6lz.CX.o8PhVmDhjTF/1JPi2SPUSHI6u7Jmv9G', 'ADMINISTRATOR');
